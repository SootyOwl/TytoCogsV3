            ...
            messages=[
                {
                    ...
                    "content": [
                        {
                            "type": "text",
                            "text": "You are an expert science communicator tasked with summarizing scientific articles for social media. Your goal is to create engaging, informative, and concise summaries that capture the essence of the research while also providing a critical perspective.\n\nHere is the scientific article you need to summarize:",
                        },
                        {
                            "type": "document",
