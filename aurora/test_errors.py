...
class TestCircuitBreaker:
    ...
    @pytest.mark.asyncio
    async def test_half_open_allows_limited_attempts(self):
    ...
    @pytest.mark.asyncio
    async def test_half_open_reopens_after_exhausting_attempts(self):
    ...
    @pytest.mark.asyncio
    async def test_half_open_stays_open_until_attempts_exhausted(self):
